...
<div class="col-lg-12 table-responsive" style="width:1100px;">
  ...
  ?>
<table width="420" height="130" style="float:left; border:solid 2px #00A64E; margin-bottom:10px;" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" colspan="3"><img  src="<?php echo ROOT; ?>include/images/i_card_format_synjee.jpg" height="90" width="430" /></td>
  </tr>
  ...
  <tr style="background:#00A64E; height:20px; color:#ffffff; font-size:13px; text-align:center;">
    <td colspan="3">Address :"Gyan Tower" Plot No. 1,2 Street No. 3, Old Shivbari Road, Bikaner</td>
  </tr>
  <tr style="background:#044525; height:20px; color:#ffffff; font-size:13px; text-align:center;">
