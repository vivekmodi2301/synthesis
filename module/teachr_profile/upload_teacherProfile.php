      ...
      if($_FILES['csv']['type']=='application/vnd.ms-excel'){
        ...
        for($j=0;$j<$count;$j++){
            ...
            $loginid=$_SESSION['logindtl']['id'];
      				$sql="insert into teacher_profile (faculty_id,faculty_name,father_name,mother_name,desiganation,subject,email,mobile_self,mobile_father,mobile_mother,gender,dob,landline_no,doj,dol,salary,working_hour,no_classes,office_time_in,office_time_out,submit_by) values($set,$loginid)";
      				// echo $sql;exit;
