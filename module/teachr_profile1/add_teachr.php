...
<form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
	<div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" class="form-control" id="roll" name="roll" value="" pattern=".{5}" maxlength="5" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" style="text-transform:capitalize;">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="class" name="class">
                        <option></option>
                        <option>Sr. Faculty</option>
                        <option>Asstt. Faculty</option>
                        <option>Trainee Faculty</option>
                    </select>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="class" name="class">
                        <option></option>
                        <option>12th Bio</option>
                        <option>11th Bio</option>
                        <option>10th</option>
                        <option>8th</option>
                    </select>
                    </div>
