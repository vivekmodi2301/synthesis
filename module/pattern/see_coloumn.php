<?php
	if (isset($_GET['id'])) {
		...
		?>
		<script>
			location.href=root_path+"index/pattern/syn_s_coloumn";
		</script>
			<?php
	}
 ?>
    ...
    <form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
                ...
                <tr class="primary1 table_style2">
                    ...
                    <td><a href="<?php echo ROOT; ?>index/pattern/syn_e_coloumn/<?php echo $patt_detail['id'];?>" title="Edit Profile"><img src=<?php echo ROOT."include/images/profile_edit.png";?> height="20" width="20" /></a> | <a href="#" onclick="del('<?php echo $patt_detail['id'];?>','<?php echo $patt_detail['tname'];?>')">Delete</a></td>
                </tr>
								<?php }?>
            </table>
          ...
          //alert(classs);
					$.ajax({
						url:root_path+'module/pattern/search_coloumn.php',
    ...
    <script>
      function del(id,tname){
        ...
        if(confirm("Do you want to delete")){
          location.href=root_path+"index.php?mod=pattern&do=syn_s_coloumn&id="+id+"&tname="+tname;
        }
      }
    </script>
