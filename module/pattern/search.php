...
<tr class="active1 table_style" style="font-weight:600;">
  ...
  <tr class="primary1 table_style2">
      ...
      <td><a href="<?php echo ROOT; ?>index/pattern/syn_e_patt/<?php echo $stu_detail['id'];?>" title="Edit Profile"><img src="<?php echo ROOT; ?>include/images/profile_edit.png" height="20" width="20" /></a>
                    | <a href="#" onclick="del('<?php echo $stu_detail['id'];?>','<?php echo $stu_detail['tname'];?>')" title="Delete Class"><img src="<?php echo ROOT; ?>include/images/trash.png" height="20" width="20" /></a>
  </tr>
  <?php }}else{?>
<tr>
