...
//exit;
		...
		?>
		<script>
			location.href=root_path+"index/pattern/syn_s_patt";
		</script>
			<?php
	}
 ?>
    ...
    <form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
                ...
                <tr class="primary1 table_style2">
                    ...
                    <td><a href="<?php echo ROOT; ?>index/pattern/syn_e_patt/<?php echo $stu_detail['id'];?>" title="Edit Profile"><img src="<?php echo ROOT; ?>include/images/profile_edit.png" height="20" width="20" /></a>
										| <a href="#" onclick="del('<?php echo $stu_detail['id'];?>','<?php echo $stu_detail['tname'];?>')" title="Delete Class"><img src="<?php echo ROOT; ?>include/images/trash.png" height="20" width="20" /></a></td>
                </tr>
								<?php }?>
            </table>
          ...
          //alert(classs);
					$.ajax({
						url:root_path+'module/pattern/search.php',
    ...
    function  del(id,tname){
        if(confirm("Do you want to delete")){
          location.href=root_path+"index.php?mod=pattern&do=syn_s_patt&id="+id+"&tname="+tname;
        }
      }
    </script>
