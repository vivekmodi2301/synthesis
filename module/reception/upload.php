        ...
        while ($data=fgetcsv($handle)) {
      	...
      	for($j=0;$j<$count;$j++){
      			...
      			$loginid=$_SESSION['logindtl']['id'];
      				$sql="insert into stu_profile (class_id,batch_id,token_no,name,f_name,m_name,f_mobile,s_mobile,m_mobile,gender,category,genrate_token,wheree) values($_POST[class_id],$_POST[batch_id],$set,$loginid,'inquiry')";
      				// echo $sql;exit;
