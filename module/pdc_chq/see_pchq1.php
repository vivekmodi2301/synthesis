...
?>
    ...
    <form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php 
                    $qry="select roll,sum(pdc.amount) as amount,count(amount) as given,stu_profile.name,f_name,scholarship,class_id,batch_id,statuss from stu_profile join pdc on pdc.roll=stu_profile.roll_no  group by roll   ";
