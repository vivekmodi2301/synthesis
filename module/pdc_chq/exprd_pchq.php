    <div class="col-lg-12 table-responsive">
        ...
        <tr class="active1 table_style" style="font-weight:600;">
            ...
            <tr class="active1 table_style" style="font-weight:600; text-align:justify;">
                    <td colspan="6" align="center">You are at : <span style="font-size:16px; color:#900;">Expired P.D.C. List</span></td>
                </tr>
                <tr class="active1 table_style" style="font-weight:600; text-align:justify;">
                    <td>Total Students in this Section : <span id="tot_stu" class="profile_chng_color"></span></td>
                    <td>Expired P.D.C.</td>
                    
                    <td><button name="" id="" class="btn btn-success btn-sm btn-block" style="font-family:'Century Gothic'; font-size:14px; font-weight:bold;" onclick="printPage('expired','')">SEND MSG</button></td>
            ...
            <table class="table table-bordered table-hover" id="show">
                ...
                <?php 
                    ...
                    $qry="select pdc.id,pdc.amount,roll,pdc.chq_no,bank_name,pdc.datee,expiry_date,stu_profile.name,f_mobile from pdc join stu_profile on pdc.roll=stu_profile.roll_no where expiry_date<='$current_date' and( statuss='recived' or statuss='expired')";
                    // echo $qry;
            ...
            if(confirm("Do you really want to "+status+" cheques")){
                ...
                if(yourArray.length>0){
                    $.ajax({
                        ...
                        data:"ids="+yourArray+"&status="+status,
                        type:"post",
                        success:function(e){
                            alert("Status Change");
                            $('#selectAll').prop('checked',false);
    ...
    <script type="text/javascript">
      function search(){
        ...
        $.ajax({
            url:root_path+"module/pdc_chq/search_exprd.php",
            data:"roll="+roll+"&stu_name="+stu_name+"&stu_chq_no="+stu_chq_no+"&stu_class="+stu_class+"&stu_batch="+stu_batch,
            type:"post",
            success:function(e){
                $('#show').html(e);
            },error:function(e){
