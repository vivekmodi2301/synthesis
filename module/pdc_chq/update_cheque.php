    ...
    <table class="table table-bordered table-hover">
            ...
            <table class="table table-bordered table-hover" id="show">
                ...
                <?php 
                    $qry="select pdc.id,pdc.amount,roll,pdc.chq_no,bank_name,pdc.datee,expiry_date,stu_profile.name,f_mobile,update_date from pdc join stu_profile on pdc.roll=stu_profile.roll_no where update_date!='' and refund='n'";
                    // echo $qry;
...
<script type="text/javascript">
      function search(){
        ...
        var a_to=$('#a_to').val();
        $.ajax({
            url:root_path+"module/pdc_chq/search_updated.php",
