    ...
    <table class="table table-bordered table-hover">
            ...
            <table class="table table-bordered table-hover">
            	<tr class="active1 table_style" style="font-weight:600; text-align:justify;">
                    <td colspan="6" align="center">You are here at : <span style="font-size:16px; color:#900;">DUE P.D.C. (Ready to Apply) List</span></td>
                </tr>
				<tr class="active1 table_style" style="font-weight:600; text-align:justify;">
                    <td>Total Students in this Section :<span id="tot_stu" class="profile_chng_color"></span></td>
                    <td>Upcoming P.D.C.</td>

                    <td>Send Msg<br><input type="checkbox" id="send_msg"></td>
            ...
            <table class="table table-bordered table-hover" id="show">
                ...
                <?php 
                    ...
                    $qry="select pdc.id,pdc.amount,roll,pdc.chq_no,bank_name,pdc.datee,expiry_date,stu_profile.name,f_mobile,update_date from pdc join stu_profile on pdc.roll=stu_profile.roll_no where (datee<'$current_date'  and statuss='recived') and refund='n'  ";
                    // echo $qry;
...
<script type="text/javascript">
      function search(){
        ...
        var a_to=$('#a_to').val();
        $.ajax({
            url:root_path+"module/pdc_chq/search_due.php",
