          ...
          <table class="table table-bordered table-hover">
            ...
            <table class="table table-bordered table-hover">
              <tr class="active1 table_style" style="font-weight:600; text-align:justify;">
                    ...
                    <td><a href="#" onclick="printPage()">Print Orange I-card</a></td>
                    <td><a href="#" onclick="printGreenPage()">Print Green I-card</a></td>
                </tr>
            </table>
              ...
              <tr class="active1 table_style" style="font-weight:600;">
                ...
                <?php 
                    $student_dtl=fetchAll("select stu_profile.id,stu_profile.name,roll_no,f_name,m_name,class.name as class,batch.name as batch,propic,f_mobile,wheree from stu_profile join class on class_id=class.id join batch on batch_id=batch.id where roll_no!=''");
                    $sno=1;
