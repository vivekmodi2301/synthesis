  ...
  <div class="col-lg-12 table-responsive">
    <form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
          <table class="table table-bordered table-hover">
            ...
            <p class="profile_chng_color">You are here at : Registered I-Card Details</p>
              <table class="table table-bordered table-hover">
              ...
              <tr class="active1 table_style" style="font-weight:600;">
                ...
                <?php 
                    $student_dtl=fetchAll("select stu_profile.id,stu_profile.name,roll_no,f_name,m_name,class.name as class,batch.name as batch,propic,f_mobile,wheree from stu_profile join class on class_id=class.id left join batch on batch_id=batch.id where roll_no='0'");
                    // echo "select stu_profile.id,stu_profile.name,roll_no,f_name,m_name,class.name as class,batch.name as batch,propic,f_mobile,wheree from stu_profile join class on class_id=class.id join batch on batch_id=batch.id where roll_no='0'";
                    $sno=1;
    ...
    <script type="text/javascript">
        ...
        function printPage(){
            ...
            if(yourArray.length>0){
                location.href=root_path+"icard.php?id="+yourArray+"&card=registration";
            }
        }
    </script>
    <!-- 
