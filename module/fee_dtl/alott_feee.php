<?php 
    ...
    if(isset($_POST['tution_fee'])){
        ...
        if($_POST['old_reg_fee']==''){
            $_SESSION['eoreg_fee']="Enter old student registration fee";
            $success=0;
        }
        if($_POST['tution_fee']==''){
        ...
        if($_POST['old_gst_value']==0){
            $_SESSION['eogst_value']="Enter proper number";
            $success=0;
        }
        ...
        if($_POST['old_total_fee']==0){
            $_SESSION['eototal_fee']="Enter proper number";
            $success=0;
        }
        if($success){
    ...
    <form role="form" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    ...
                    <select onchange="show_batch(this.value,'')" tabindex="1" class="form-control"  id="" name="class_id">
                        ...
                        <?php 
                            $class_data=fetchAll("select class.id,class.name from class left join class_fee_dtl on class_id!=class.id group by class.id");
                ...
                <div class="form-group">
                    <label class="col-lg-4 control-label">Old Student Registration Fee</label>
                    <div class="col-lg-8">
                    <input type="text" class="form-control" id="old_reg_fee" tabindex="3" name="old_reg_fee" value="<?php if(isset($_POST['old_reg_fee'])){echo $_POST['old_reg_fee'];}elseif($id){ echo $class_fee_dtl['old_reg_fee'];} ?>" style="text-transform:capitalize;">
                    <?php if(isset($_SESSION['eoreg_fee'])){echo $_SESSION['eoreg_fee']; unset($_SESSION['eoreg_fee']);} ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-lg-4 control-label">Old Studnet G.S.T. Value</label>
                    <div class="col-lg-8">
                    <input type="text" class="form-control" id="old_gst_value" name="old_gst_value" value="<?php if(isset($_POST['old_gst_value'])){echo $_POST['old_gst_value'];}elseif($id){ echo $class_fee_dtl['old_gst_value'];} ?>" style="text-transform:capitalize;">
                    <?php if(isset($_SESSION['eogst_value'])){echo $_SESSION['eogst_value']; unset($_SESSION['eogst_value']);} ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-lg-4 control-label">Old Student Total Fee</label>
                    <div class="col-lg-8">
                    <input onfocus="gettotal()" tabindex="8" type="text" class="form-control" id="old_total_fee" name="old_total_fee" value="<?php if(isset($_POST['old_total_fee'])){echo $_POST['old_total_fee'];}elseif($id){ echo $class_fee_dtl['old_total_fee'];} ?>" style="text-transform:capitalize;">
                    <?php if(isset($_SESSION['eototal_fee'])){echo $_SESSION['eototal_fee']; unset($_SESSION['eototal_fee']);} ?>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function gettotal(){
        ...
        var old_reg_fee=parseInt($('#old_reg_fee').val());
        ...
        var old_total_fee_without_gst=parseInt(old_reg_fee+tution_fee+test_series_fees+study_matirial_fee);
        var gst_value=parseInt((total_fee_without_gst/100)*gst_per);
        var old_gst_value=parseInt((old_total_fee_without_gst/100)*gst_per);
        $('#gst_value').val(gst_value);
        $('#old_gst_value').val(old_gst_value);
        var total_fee_with_gst=gst_value+total_fee_without_gst;
        var old_total_fee_with_gst=old_gst_value+old_total_fee_without_gst;
        $('#total_fee').val(total_fee_with_gst);
        $('#old_total_fee').val(old_total_fee_with_gst);
    }
</script>
<?php 
    if($id){
