...
?>
    <div class="col-lg-12 table-responsive" style="margin-left:10px; font-family:'Century Gothic';">
            	...
            	<tr class="active1 table_style" style="font-weight:600;">
                    ...
                    <td width="300">Old Student Registration Fees</td>
                    <td width="300">Tution Fees</td>
                    <td width="300">Test Series Fees</td>
                    <td width="300">Study Material Fees</td>
                    <td width="200">GST %</td>
                    <td width="300">GST Value</td>
                    <td width="300">Old Student GST Value</td>
                    <td width="300">Total Fee</td>
                    <td width="300">Old Student Total Fee</td>
                    <td width="200" >Action</td>
                </tr>
                <?php 
                    $sno=1;
                    $class_fee_data=fetchAll("select class.name as class,class_fee_dtl.id,reg_fee,tution_fee,test_series_fees,study_matirial_fee,gst_per,gst_value,total_fee,old_reg_fee,old_gst_value,old_total_fee from class_fee_dtl join class on class_id=class.id ");
                ...
                ?>
                        <tr class="primary1 table_style2">
                            ...
                            <td><?php echo $class_fee_value['old_reg_fee'] ?></td>
                            ...
                            <td><?php echo $class_fee_value['old_gst_value']; ?></td>
                            <td><?php echo $class_fee_value['total_fee'] ?></td>
                            <td><?php echo $class_fee_value['old_total_fee'] ?></td>
