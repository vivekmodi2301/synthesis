             ...
             <tr class="active1 table_style" style="font-weight:600;">
               ...
               <?php
                 $sno=1;
                 	...
                 	$url="smodule/spr/show_stu_result.php?class=".$class."&pattern=".$pattern;
                 	$limit=1;
                 	$frmdataget=$_REQUEST;
                 	...
                 	echo "select neet_1.roll,name,`exam_date`,neet_1.id,`a`,`b`,`c`,`d`,`e` from neet_1 join stu_profile on neet_1.roll=stu_profile.roll_no where 1 and neet_1.roll like'5%' limit 0, 10";//exit;
