             ...
             <tr class="active1 table_style" style="font-weight:600;">
              ...
              $tablename=strtolower($name)."_".$class;
               ...
               <tr class="primary1 table_style2">
                   ...
                   <?php
                   $s_name=fetchOne("select stu_profile.name,batch.name as batch from stu_profile join batch on batch_id=batch.id where roll_no=$patt_detail[roll]");
                   // echo "select name,batch.name as batch from student_profile join batch on batch_id=batch.id where roll_no=$patt_detail[roll]";
                   ?>
                   <td><?php  echo $s_name['name'];?></td>
...
<script type="text/javascript">
  function search(classs,pattern) {
    ...
    //alert(roll);
    $.ajax({
        url:root_path+"module/spr/show_stu_result.php",
